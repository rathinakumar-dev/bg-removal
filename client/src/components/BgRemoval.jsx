...
const BgRemoval = () => {
  ...
  return (
    <div className="pb-10 md:py-20 mx-2">
      <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-center bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent mb-12 sm:20">
